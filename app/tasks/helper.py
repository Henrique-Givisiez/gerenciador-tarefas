    ...
    def create(self, user_id: int, task_type: str, task_description: str, task_date: str):
        ...
        try:
            if task_type and task_date:  # Verifica se os campos obrigatórios foram fornecidos
                ...
                self.conn.commit()
                success = True
                msg = "Tarefa adicionada com sucesso!"  # Mensagem de sucesso
                return success, msg
            
            else:
                msg = "Campos incompletos!"  # Mensagem de erro se os campos obrigatórios estiverem faltando
                return success, msg
        ...
        try:
            ...
            if user_id:
                ...
                for task in user_tasks:
                    task = list(task)
                    task[4] = strftime("%d/%m/%Y")  # Formata a data da tarefa
