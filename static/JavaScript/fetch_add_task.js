...
function addTaskToPendingTasks(dado) {
    var div_pending_content= document.getElementById("pendingContent");
    if (div_pending_content){
    ...
    div_task_box.setAttribute("status", dado.status)
    ...
    h5_header.innerHTML = dado.type;
    p_content.innerHTML = dado.description;
    span_footer.innerHTML = dado.date;
    ...
    div_task_box.setAttribute("id_tarefa", dado.id);

    div_pending_content.appendChild(div_task_box);
